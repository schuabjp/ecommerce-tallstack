    ...
    <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div>
                ...
                <textarea wire:model="description" rows="4" class="w-full border-gray-300 rounded-lg shadow-sm"></textarea>
                @error('description') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
            </div>

            <div class="flex justify-end gap-3">
                <a href="{{ route('products.index') }}" wire:navigate class="px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-lg">
                    Cancelar
                </a>
